...
class MainScene extends Phaser.Scene {
	...
	preload() {
		const { skull, powerups } = Assets.PhaserLabs.obj;
		this.load.obj("skull", skull.obj);
		this.load.image("powerups", powerups.png);
	}
	...
	create() {
		...
		const mesh = this.add.mesh(middleWidth, middleHeight, "powerups").addVerticesFromObj("skull", 0.1).panZ(7);
